...
const int MAX_HEIGHT = 257; // 블록 높이의 최댓값
const int INF = 987'654'321; // 무한대를 나타내는 값, 최댓값이 12,800,000이므로 큰 수인 987654321을 사용

// 모든 땅의 높이를 height로 만드는 비용 계산 함수
...
// 모든 땅의 높이를 같게 만드는 최소 비용과 그 때의 땅의 높이를 반환하는 함수
